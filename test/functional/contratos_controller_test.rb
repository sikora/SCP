...
class ContratosControllerTest < ActionController::TestCase
  ...
  test "should create contrato" do
    assert_difference('Contrato.count') do
      post :create, contrato: { desccontrato: @contrato.desccontrato, dt_fim: @contrato.dt_fim, dt_inicio: @contrato.dt_inicio, id: @contrato.id, id_tipocontrato: @contrato.id_tipocontrato }
    end
  ...
  test "should update contrato" do
    put :update, id: @contrato, contrato: { desccontrato: @contrato.desccontrato, dt_fim: @contrato.dt_fim, dt_inicio: @contrato.dt_inicio, id: @contrato.id, id_tipocontrato: @contrato.id_tipocontrato }
    assert_redirected_to contrato_path(assigns(:contrato))
  end
