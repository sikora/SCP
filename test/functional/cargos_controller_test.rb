...
class CargosControllerTest < ActionController::TestCase
  ...
  test "should create cargo" do
    assert_difference('Cargo.count') do
      post :create, cargo: { dt_fim: @cargo.dt_fim, dt_inicio: @cargo.dt_inicio, nm_cargo: @cargo.nm_cargo, simbolo: @cargo.simbolo }
    end
  ...
  test "should update cargo" do
    put :update, id: @cargo, cargo: { dt_fim: @cargo.dt_fim, dt_inicio: @cargo.dt_inicio, nm_cargo: @cargo.nm_cargo, simbolo: @cargo.simbolo }
    assert_redirected_to cargo_path(assigns(:cargo))
  end
